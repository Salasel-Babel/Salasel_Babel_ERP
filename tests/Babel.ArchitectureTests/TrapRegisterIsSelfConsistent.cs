...
/// <para>
/// <b>العطل الذي يجعله مستحيلاً:</b> تصادم معرّفات بين فرعين متوازيين. وقع <b>ثلاث مرات</b>
/// في هذا المستودع (فخ-38/39، ثم «القاعدة 10»، ثم فخ-41)، وكل مرة كلّف إعادة ترقيم يدوية
...
/// </para>
/// <para>
/// <b>لماذا اختبار لا مراجعة:</b> الثلاث مرات السابقة وقعت كلها ومعها اصطلاح مكتوب.
...
public sealed partial class TrapRegisterIsSelfConsistent
{
    ...
    private const int MinimumTrapCount = 43;
