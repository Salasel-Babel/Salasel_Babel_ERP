...
/** صنف الشريحة. */
export type VoiceSlotKind = "Entity" | "Number" | "Money" | "Quantity" | "Date" | "Code" | "Choice" | "Prose";
...
export interface VoiceSlot {
  ...
  /**
   * مفتاح السجلّ الذي يُحلّ فيه اسمُ الطرف — لشريحة `Entity` وحدها.
   * **ولا يُقرأ منه شيء في المتصفّح**: يُرسَل كما هو ليعرف الخادم أي سجلٍّ يُسأل.
   */
