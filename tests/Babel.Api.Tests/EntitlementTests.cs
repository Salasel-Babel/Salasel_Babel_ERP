...
/// </para>
/// <para>
/// <b>وملاحظة على ما لا يمكن اختباره:</b> «مستأجر دفترُه للقراءة فقط» حالة <b>غير قابلة
/// للتمثيل</b> في النموذج الحالي — <c>EntitlementSet.Create</c> يرفض أي وحدة إلزامية
/// (النواة والدفتر) بحالة غير <c>Entitled</c>. ولذلك تُشهَد «القراءة تعمل والترحيل يُمنع»
/// على وحدة اختيارية (المبيعات)، والقيد نفسه مسجَّل في التقرير بوصفه سؤالاً على المالك:
/// ماذا يحدث لدفتر عميلٍ توقّف عن الدفع؟
/// </para>
/// </summary>
