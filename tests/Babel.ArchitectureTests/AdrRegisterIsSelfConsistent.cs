...
public sealed partial class AdrRegisterIsSelfConsistent
{
    ...
    /// <para>
    /// <b>ومُدَّ إلى الثمانين حين بلغ السجل الثالث والسبعين، ثمّ إلى التسعين حين بلغ
    /// الحادي والثمانين.</b> والمرّة الثانية <b>وقعت اصطداماً لا استباقاً</b>: نزل القرار
    /// الحادي والثمانون فسقطت البوّابة برسالة «كلمة العدد غير معروفة»، وهي رسالة صحيحة عن
    /// حدٍّ في الحارس لا عن عطلٍ في الفهرس. والدرس أدناه هو سببُ المدّ نفسه: قاموسٌ ينفد
    /// يُدرّب من يصطدم به على توسيعه بلا قراءة — فيُمَدّ عشرةً عشرة <b>قبل</b> أن يُصطدم به.
    /// </para>
    /// <para>
    ...
    [
        ...
        "الحادي والثمانون", "الثاني والثمانون", "الثالث والثمانون", "الرابع والثمانون",
        "الخامس والثمانون", "السادس والثمانون", "السابع والثمانون", "الثامن والثمانون",
        "التاسع والثمانون", "التسعون",
        "الحادي والتسعون", "الثاني والتسعون", "الثالث والتسعون", "الرابع والتسعون",
        "الخامس والتسعون", "السادس والتسعون", "السابع والتسعون", "الثامن والتسعون",
        "التاسع والتسعون", "المئة",
    ];
