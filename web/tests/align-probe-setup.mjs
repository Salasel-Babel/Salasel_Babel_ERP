...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   **لماذا وُجد.** `scripts/align-audit.mjs` يزور كل مسارٍ في `SCREENS` كما
   يفتحه زائرٌ أول، وثلاثةُ نماذجَ في هذا التسليم **لا تُرسَم لزائرٍ أول**:
     ...
     · نموذجُ التأسيس على حالٍ **مقروءة** — «لم تُؤسَّس بعد» بالرمز
       `company_setup.not_found`. والخادم الوهمي يردّ منشأةً **مؤسَّسة** لمن
       يحمل اعتماداً، ويردّ 401 لمن لا يحمله — وهو ما يفعله المقياس الحاكم.
       فالحالُ الوحيدة التي يُرسَم فيها النموذج **عن علم** لا يبلغها المسحُ
       الساكن بحال. وهذا صحيحٌ في المنتج ولا يُغيَّر لأجل مقياس.
