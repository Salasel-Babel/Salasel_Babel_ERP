...
public sealed class PublishedContractTests
{
    ...
    public async Task العقد_يصف_كل_ما_يحتاجه_فريق_الواجهة_ولا_يصف_باباً_غير_موجود()
    {
        ...
        // ‏**111 عمليةً — والعدد مكتوب بيد عمداً.** عدٌّ مشتقٌّ من الوثيقة نفسها يقارنها
        ...
        // والتنزيل بها.
        // ثم من 76 إلى **111** بخمسةٍ وثلاثين باباً للمقاولات: المشاريع وعقودها
        // وجداول كمياتها وأوامرها التغييرية، والمقاولون من الباطن وعقودهم، ومستخلص
        // العميل ومستخلص الباطن ودفعة المقاول المقدمة والإفراج عن المحتجز وتحصيله —
        // كلٌّ منها **ثلاثة أبواب: أنشئ · اقرأ · رحّل** — وسجلّ المحتجزات وكشف
        // المقاولين وموقف العقد. و**بابان لا ثلاثة** في موضعين: الأمر التغييري وخطاب
        // الضمان، لأن أوّلهما التزامٌ تعاقدي وثانيهما سجلّ، ولا حدث لأيٍّ منهما في
        // مصفوفة الترحيل — ومخطّطا جوابيهما **بلا entryId وبلا alreadyPosted**.
        //
        ...
        Assert.Equal(111, paths.EnumerateObject().SelectMany(static p => p.Value.EnumerateObject())
