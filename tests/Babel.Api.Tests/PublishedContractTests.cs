...
public sealed class PublishedContractTests
{
    ...
    public async Task العقد_يصف_كل_ما_يحتاجه_فريق_الواجهة_ولا_يصف_باباً_غير_موجود()
    {
        ...
        // ‏**45 عمليةً — والعدد مكتوب بيد عمداً.** عدٌّ مشتقٌّ من الوثيقة نفسها يقارنها
        ...
        // وتجديدها وإبطالها، ودعوة عضو وقراءة الأعضاء. ثم من 38 إلى **45** بسبعة أبواب
        // للمرفقات على ستّة مسارات: الإيداع والجرد على المورد الرئيسي، وقراءة الوصف على
        // المرفق، وثلاثة موارد فرعية — إصدارٌ جديد، وسحب، وسكّ تذكرة — وباب تنزيلٍ بتذكرة.
        // ولا PUT ولا PATCH ولا DELETE على مرفق: التصحيح إصدارٌ يشير إلى سلفه، والإزالة
        // علامة سحب (ADR-0046).
        //
