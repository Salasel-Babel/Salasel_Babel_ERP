...
/// وبلا اعتمادات</b>. النسخة العلائقية في Persistence/ هي نسخة الإنتاج.
/// </summary>
public sealed class InMemoryComplianceStore : IComplianceStore, IDisposable
{
    ...
    /// <summary>يُحرِّر بوّابة تسلسل المعاملات. المخزن مُملوك لحاويةِ الحقن التي أنشأته.</summary>
    public void Dispose() => _txGate.Dispose();
