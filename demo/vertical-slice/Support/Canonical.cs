// ---------------------------------------------------------------------------
// نُسخ حرفياً من spikes/relational-stack/Support/Canonical.cs (لم يتغيّر سوى اسم النطاق).
// Copied verbatim from spikes/relational-stack/Support/Canonical.cs — only the
// namespace differs. Do NOT diverge: the hash chain in the spike and the hash
// chain in this demo must be byte-for-byte the same function.
// ---------------------------------------------------------------------------
