...
| الفرع | الغرض |
|---|---|
| `main` | فرع المالك — لا يُدفع إليه مباشرة |
| `collab/asadrahwan` | فرع المتعاون — تتجمع فيه أعمال التطوير قبل الدمج في `main` |
| `claude/*` | فروع العمل — تتفرع من فرع المتعاون وتُدمج فيه |
