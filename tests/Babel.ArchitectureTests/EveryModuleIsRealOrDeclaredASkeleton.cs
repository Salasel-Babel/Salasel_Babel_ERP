...
/// ومنها اليوم <b>ستٌّ</b> ليست إلا بطاقة وحدة من سبعة عشر سطراً — والبناء أخضر،
...
public sealed class EveryModuleIsRealOrDeclaredASkeleton
{
    ...
    [
        ...
        (BabelModule.RealEstate,
            "العقاري: اثنان وأربعون حدثاً في data/posting-matrix/events/realestate.json بلا كاتب — وهو أكبر "
            + "ملفّ في المصفوفة. والاستحقاق الدوري نمطٌ لا تملكه أي وحدة اليوم، وسبعة بنود في "
            + "docs/evidence/verification-debt.md تخصّه وحده — ثلاثةٌ منها في الطبقة حاجز. ولا تُباع في أي خطة اليوم."),
