...
public sealed class ProjectsVoiceIntents : IVoiceIntentCatalogue
{
    ...
    [
        new VoiceIntent(
            ...
            [
                new VoiceSlot("contract", VoiceSlotKind.Entity, "العقد", true,
                    ["للعقد", "العقد", "عقد"], [], "contract"),
                new VoiceSlot("reason", VoiceSlotKind.Prose, "سبب التغيير", true,
                    ["بسبب", "السبب", "لان"], []),
        ...
        new VoiceIntent(
            ...
            [
                new VoiceSlot("contract", VoiceSlotKind.Entity, "العقد", true,
                    ["عقد", "العقد", "للعقد", "بعقد"], [], "contract"),
                new VoiceSlot("boqItem", VoiceSlotKind.Entity, "بند جدول الكميات", true,
                    ["بند", "البند", "للبند", "بندي"], [], "boqItem"),
        ...
        new VoiceIntent(
            ...
            [
                new VoiceSlot("subcontractor", VoiceSlotKind.Entity, "المقاول من الباطن", true,
                    ["للمقاول", "المقاول", "مقاول", "لصالح"], [], "subcontractor"),
        ...
        new VoiceIntent(
            ...
            [
                new VoiceSlot("subcontract", VoiceSlotKind.Entity, "عقد الباطن", true,
                    ["عقد", "العقد", "للعقد"], [], "subcontract"),
                new VoiceSlot("boqItem", VoiceSlotKind.Entity, "بند جدول الكميات", true,
                    ["بند", "البند", "للبند"], [], "boqItem"),
                new VoiceSlot("quantity", VoiceSlotKind.Quantity, "الكمية المنفذة", true,
        ...
        new VoiceIntent(
            ...
            [
                new VoiceSlot("subcontractor", VoiceSlotKind.Entity, "المقاول من الباطن", true,
                    ["للمقاول", "المقاول", "مقاول"], [], "subcontractor"),
            ],
            false,
            null),
    ];
