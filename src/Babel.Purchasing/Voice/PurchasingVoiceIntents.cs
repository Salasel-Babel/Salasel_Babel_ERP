...
public sealed class PurchasingVoiceIntents : IVoiceIntentCatalogue
{
    ...
    [
        ...
        new VoiceIntent(
            ...
            [
                new VoiceSlot("supplier", VoiceSlotKind.Text, "المورد", true,
                    ["من المورد", "المورد", "مورد"], []) { Entity = VoiceEntityKind.Supplier },
                new VoiceSlot("item", VoiceSlotKind.Text, "الصنف", true,
                    ["الصنف", "صنف", "للصنف"], []) { Entity = VoiceEntityKind.Item },
        ...
        new VoiceIntent(
            ...
            [
                new VoiceSlot("supplier", VoiceSlotKind.Text, "المورد", true,
                    ["من", "المورد", "مورد", "باسم", "لصالح"], []) { Entity = VoiceEntityKind.Supplier },
                new VoiceSlot("amount", VoiceSlotKind.Money, "الإجمالي شامل الضريبة", true,
        ...
        new VoiceIntent(
            ...
            [
                new VoiceSlot("supplier", VoiceSlotKind.Text, "المورد", true,
                    ["للمورد", "المورد", "مورد", "لصالح", "الى"], []) { Entity = VoiceEntityKind.Supplier },
