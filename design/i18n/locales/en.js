/* ═══════════════════════════════════════════════════════════════════════════
   English  —  LTR.  Translation quality: HUMAN (written, not machine).
   ───────────────────────────────────────────────────────────────────────────
   Structure must mirror ar.js key for key. Run `node design/audit.js` (or open
   design/audit.html) after any edit: a missing key here silently falls back to
   Arabic, which is safe but wrong, and only the audit will tell you.
   ═══════════════════════════════════════════════════════════════════════════ */
(function (global) {
  "use strict";
  global.SB.I18N.define("en", {
    lang: "en", dir: "ltr", native: "English", english: "English",
    fallback: "ar", source: false, translation: "human",
    pluralLocale: "en",
    numbers: {
      group: ",", decimal: ".", groupSizes: [3], digits: "latn",
      minus: "-", percentSuffix: "%", currency: "SAR", currencyCode: "SAR"
    },
    dates: {
      shortPattern: "{year}-{month}-{day}",
      longPattern: "{weekday}, {day} {month} {year}",
      eraGregorian: "", eraHijri: "AH", emptyDash: "—",
      months: ["January","February","March","April","May","June",
               "July","August","September","October","November","December"],
      weekdays: ["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],
      hijriMonths: ["Muharram","Safar","Rabi' I","Rabi' II","Jumada I","Jumada II",
  ...
  css: { draftStamp: "DRAFT — NOT POSTED", draftSuffix: " (draft)" },
  ...
  app: {
    ...
    theme: { toggle: "Toggle theme", light: "Light theme", dark: "Dark theme",
             palette: "Colour palette", paletteDefault: "Approved", paletteAccessible: "Proposed (accessible)" },
    locale: { label: "Language", aria: "Choose interface language", digitShape: "Digit shape (display only)" },
    a11y: { openNav: "Open navigation", help: "Help", notifications: "Notifications",
            close: "Close", rowOptions: "Line options", crumbs: "Breadcrumb",
            mainNav: "Main navigation", gallerySections: "Gallery sections" },
    nav: {
      home: "Home", dashboard: "Dashboard", sales: "Sales", inventory: "Inventory",
      hr: "Human resources", gl: "General ledger", settings: "Settings",
      designGallery: "Design system gallery",
      chart: "Chart of accounts", journals: "Journal entries", ledger: "General ledger",
      trialBalance: "Trial balance", reports: "Financial reports", budget: "Budget"
    }
  },

  common: {
    action: {
      save: "Save", saveDraft: "Save as draft", cancel: "Cancel", close: "Close", back: "Back",
      print: "Print", export: "Export", refresh: "Refresh report", retry: "Try again",
      deleteFinal: "Delete permanently", confirmDelete: "Yes, delete", duplicate: "Duplicate line",
      deleteLine: "Delete line", duplicateEntry: "Duplicate entry", printVoucher: "Print voucher",
      deleteDraft: "Delete draft", addLine: "Add line", search: "Search", clearSearch: "Clear search",
      post: "Post entry", reverse: "Reverse entry", recalculate: "Recalculate",
      previewEntry: "Preview entry (modal)", confirmDialog: "Confirm delete (small modal)",
      accountDrawer: "Account details (drawer)", actionsMenu: "Actions menu",
      openLedger: "Open ledger", copyError: "Copy error text",
      reviewUnbalanced: "Review unbalanced lines", addAdjusting: "Add adjusting line",
      ignore: "Dismiss", newEntry: "New entry", import: "Import",
      printTrialBalance: "Print trial balance", runAudit: "Run the audit on this page"
    },
    label: {
      all: "All", none: "None", select: "— select —", selectAccount: "— select account —",
      dash: "—", perPage: "Per page", status: "Status", date: "Date", type: "Type",
      classification: "Classification", parentAccount: "Parent account", currentBalance: "Current balance",
      lastMovement: "Last movement", format: "Format", level: "Detail level", from: "From",
      to: "To", required: "Required field",
    ...
    count: {
      selected: { "=0": "Nothing selected", one: "1 item selected", other: "{count} items selected" },
      validationErrors: {
      ...
      lines: { "=0": "No lines", one: "1 line", other: "{count} lines" },
      accounts: { "=0": "No accounts", one: "1 account", other: "{count} accounts" },
      entries: { "=0": "No entries", one: "1 entry", other: "{count} entries" },
      similarEntries: {
    ...
    charName: {
      ...
      "061C": "Arabic letter mark", "202A": "LTR embedding", "202B": "RTL embedding",
      "202C": "pop directional formatting", "202D": "LTR override", "202E": "RTL override",
      "2066": "LTR isolate", "2067": "RTL isolate", "2068": "first-strong isolate", "2069": "pop isolate",
  ...
  acct: {
    ...
    debitCur: "Debit ({currency})", creditCur: "Credit ({currency})",
    debitTotal: "Total debit ({currency})", creditTotal: "Total credit ({currency})",
    taxTotal: "Total VAT ({currency})", difference: "Difference ({currency})",
    total: "Total", grandTotal: "Grand total",
    balanced: "Balanced", unbalanced: "Out of balance",
    entryState: "Entry state", entryBalanced: "Entry is balanced", entryUnbalanced: "Entry is out of balance",
    tbState: "Trial balance state", tbBalanced: "Trial balance is balanced",
    natureDebit: "Debit nature", natureCredit: "Credit nature",
    openingBalance: "Opening balance", periodMovement: "Period movement", closingBalance: "Closing balance",
    ...
    status: {
      draft: "Draft", posted: "Posted", reversed: "Reversed", pending: "Awaiting approval",
      rejected: "Rejected", archived: "Archived", active: "Active", postable: "Postable",
      openPeriod: "Open period", postedOnly: "Posted entries only"
    },
    tax: { type: "VAT type", rate: "VAT rate", amount: "VAT amount ({currency})",
           input: "Input VAT", output: "Output VAT", zero: "Zero-rated", exempt: "Exempt",
           exclusive: "Amount excludes VAT", inclusive: "Amount includes VAT",
           inputAt: "Input VAT 15%", none: "No VAT on this entry" },
    calendar: { gregorian: "Gregorian", hijri: "Hijri (Umm al-Qura)" },
    class: { assets: "Assets", liabilities: "Liabilities", equity: "Equity",
             revenue: "Revenue", expenses: "Expenses" },
    totalOf: "Total {class}",
    columns: { entryNo: "Entry no.", date: "Date", memo: "Description", account: "Account",
               costCentre: "Cost centre", action: "Action", seq: "#" }
  },

  field: {
    reference: { label: "Reference", value: "Invoice 0587-2026" },
    memo: { label: "Description", ph: "Type the line description…", hint: "Appears in the ledger and on the account statement.", linePh: "Line description" },
    entryNo: { label: "Entry no.", hint: "(system number — gapless counter)" },
    branch: { label: "Branch", main: "Head office — Riyadh", jeddah: "Jeddah branch",
              dammam: "Dammam branch", all: "All branches" },
    period: { label: "Fiscal period", open: "05/2026 — open", value: "05/2026" },
    costCentre: { label: "Cost centre", error: "A cost centre is required for expense accounts.",
                  it: "IT department", finance: "Finance department", projects: "Projects department" },
    ...
    currency: { label: "Currency", ok: "Books currency", sar: "Saudi riyal (SAR)" },
    entryDate: { label: "Entry date" },
    dueDate: { label: "Due date" },
    calendarPref: { label: "Calendar preference", hint: "A per-user display preference. It never touches storage." },
    account: { label: "Account", ph: "Search by account number or name…",
    ...
    searchEntries: { label: "Search", ph: "Search by entry number or description…" },
    searchAccounts: { label: "Search accounts", ph: "Search by account number or name…" },
    notes: { label: "Internal notes", ph: "Notes that do not appear in external reports…" },
    exchangeRate: { label: "Exchange rate" },
    createdBy: { label: "Created by" },
    defaultProject: { label: "Default project", value: "Babel Towers project" },
    debitAmount: { label: "Debit amount", error: "The amount must be greater than zero." },
    accountNo: { label: "Account number", ok: "Detail account — postable." },
    vendorName: { label: "Vendor name", value: "Tech Company",
                  hint: "The invisible-character guard is active on this field — paste text from a browser to try it." },
    detailLevel: { label: "Detail level", detail: "Detail accounts",
                   groups: "Groups", classes: "Top-level classes" },
    negativeDebit: { label: "Debit — negative value" },
    rejectedCredit: { label: "Credit — rejected" }
  },

  screen: {
    journal: {
      accounts: {
        a6120101: "IT services expense", a6110101: "Salaries and wages",
        a2010101: "Vendor / Tech Company", a1020101: "Al Ahli Bank — current account",
        a4101001: "Sales revenue", a121201: "VAT — input"
      },
      memoTech: "IT services expense", memoVat: "Value added tax",
      memoVendor: "Tech Company", vendorInvoice: "Tech Company — invoice 0587",
      entryType: "Expense entry",
      chips: { tech: "IT services expense", vat: "VAT — input", vendor: "Vendor / Tech Company" },
      preview: { title: "Preview the entry before posting" },
      confirm: { title: "Delete this draft permanently?",
      ...
      drawer: { title: "6120101 — IT services expense", recent: "Last 3 movements",
                classification: "Operating expenses", parent: "61201 — IT expenses" },
      alert: {
        ...
        dbAttempt: "Attempted at:", dbRef: "Reference id:", dbUser: "User:",
      ...
      tabs: { details: "Entry details", extra: "Additional information", notes: "Notes", audit: "Audit log",
              detailsBody: "First panel. Move between tabs with the arrow keys — their direction follows the active language." },
      rows: {
        r1: { memo: "IT services expense — period 05/2026" },
        r2: { memo: "Collection from customer Al Nour Company" },
        r3: { memo: "Inventory adjustment — main warehouse" },
        r4: { memo: "Payroll for 04/2026" },
        r5: { memo: "Reversal of entry JV-2026-00118" },
        r6: { memo: "Material purchases — Babel Towers project" },
        r7: { memo: "Fiscal year 2025 closing entry" }
      }
    },
    ...
    trialBalance: {
      ...
      viewAll: "All", viewDebit: "Debit only", viewCredit: "Credit only",
      ...
      idleAccounts: { "=0": "no dormant accounts", one: "1 dormant account", other: "{count} dormant accounts" },
      classCount: { "=0": "no classes", one: "1 class", other: "{count} classes" },
      grandTotalOf: {
      ...
      export: {
        ...
        xlsx: "Excel workbook (xlsx)", pdf: "PDF file",
    ...
    voucher: {
      ...
      cr: "Commercial registration:", vatNo: "VAT number:", phone: "Phone:", email: "Email:",
      qrAria: "QR code placeholder", qrCaption: "QR code",
      qrCaption2: "generated on approval",
      hijriDate: "Hijri date",
      preparedBy: "Prepared by — {name}", reviewedBy: "Reviewed by — responsible accountant",
  ...
  gallery: {
    ...
    badge: { approved: "Approved visual reference", rtl: "RTL-native, not mirrored",
             noframework: "No framework · no build step", i18n: "Four languages · keys, not strings" },
    toc: { colors: "Colours", type: "Type", space: "Spacing", buttons: "Buttons",
           fields: "Fields", amounts: "Amounts", line: "Entry line", tables: "Tables",
           states: "States", alerts: "Alerts", overlays: "Overlays", empty: "Empty and loading",
           print: "Print", i18n: "i18n", audit: "Audit",
           trialBalance: "Trial balance screen ↗", rules: "Rules guide ↗" },
    sec: {
      color: "Colours", type: "Type and the typographic ladder",
      space: "Spacing, radii, shadows and motion", buttons: "Buttons",
      fields: "Fields and forms", amounts: "Amounts — cell, input and debit/credit pair",
      line: "Journal line editor",
      table: "Data table — sticky header, sortable columns, aligned totals row",
      pills: "Status pills", alerts: "Alerts and live validation",
      overlays: "Modals, drawers and menus", nav: "Tabs and breadcrumbs",
      states: "Empty, loading and error states", stats: "Statistics and balance state",
      toasts: "Transient notifications", print: "Printing",
    ...
    demo: {
      ...
      wRegular: "Regular 400", wMedium: "Medium 500", wSemibold: "Semibold 600", wBold: "Bold 700",
      sampleLine: "A balanced journal entry",
      isolation: "Numbers: bidirectional isolation",
      isolationBad: "Without isolation (wrong)", isolationGood: "With isolation (right)",
      isolationRow1: "Balance -1,250.00 riyals", isolationRow2: "Invoice INV-2026-0587 is on hold",
      ...
      radii: "Radii", shadows: "Shadows", motion: "Motion",
      motionNote: "Every transition is cancelled under prefers-reduced-motion: reduce — applied once for everything.",
      btnTypes: "Variants", btnStates: "States — hover, and press Tab to see the focus ring",
      btnDefault: "Default", btnHover: "Hover", btnFocus: "Focus — press Tab",
      btnDisabled: "Disabled (entry out of balance)", btnLoading: "Posting…",
      btnDisabledShort: "Disabled", btnLoadingShort: "Loading", btnDeleteDisabled: "Delete disabled",
      btnBlock: "Full width", btnSmall: "Small",
      ...
      amtCase: "Case", amtShown: "Rendered", amtToken: "Semantic token", amtNote: "Note",
      amtDebit: "Debit amount", amtCredit: "Credit amount", amtNeutral: "Neutral amount",
      amtNegative: "Negative amount", amtZero: "Zero", amtMuted: "Muted (reference)", amtTotal: "Total",
      amtWithCur: "With currency", amtLarge: "Large", amtAcctCode: "Account number",
      amtNoteW600: "weight 600", amtNoteOutside: "outside the two sides of the entry",
      amtNoteSign: "sign left of the number — isolation is mandatory", amtNoteDash: "shows a dash, not a zero",
      amtNotePrev: "prior balance", amtNoteTotalRow: "totals row",
      amtNoteCur: "the currency symbol never separates from the number", amtNoteStat: "stat card",
      amtNoteIso: "isolated and tabular", amtNoteW700: "weight 700",
      ...
      pageAlerts: "Page-level alerts", dbReject: "Database-level rejection — full content width",
      ...
      toastNeutral: "Neutral", toastSuccess: "Success", toastWarning: "Warning", toastDanger: "Danger",
      ...
      openTrialBalance: "Trial balance screen", openRules: "Arabic rules guide"
    },
    i18n: {
      ...
      fmtDisplay: "Display (into)", fmtMachine: "Machine (machine)", fmtCoerce: "Implicit coercion",
      ...
      hazardLocale: "Locale", hazardNumber: "Number", hazardDate: "Date", hazardMarks: "Invisible characters",
      hazardNone: "none",
    ...
    audit: {
      run: "Run the audit", clean: "No findings — clean",
      missingKeys: "Missing keys", orphanKeys: "Orphaned keys",
      pluralGaps: "Missing plural categories", paramGaps: "Mismatched placeholders",
      hardcoded: "Strings hard-coded in markup", convention: "Key-convention violations",
      keyCount: "Key count", categories: "Plural categories",
  ...
  audit: {
    ...
    sec: { keys: "Key coverage", plurals: "Plural categories", params: "Placeholders",
           convention: "Key naming convention", intl: "Intl hazards — measured live",
           files: "File-level audit (command line)", dom: "Strings hard-coded in markup" },
    ...
    ok: "pass", fail: "finding", total: "Total"
  }
