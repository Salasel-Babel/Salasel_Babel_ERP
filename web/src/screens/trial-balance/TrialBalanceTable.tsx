...
/* ═══ الاسم: أيّهما السجلّ وأيّهما ترجمة ═══════════════════════════════════
   ...
   ✔ و nameEn **حُذف من العقد** بعدها (ADR-0018 · تعديل v1 في 2026-08-26): بقاؤه
   مهجوراً كان يبقي الامتياز البنيوي للإنجليزية على السلك، وكان يُغري بارتدادٍ
   إليها. ولا سطر في هذا الملف يتغيّر بحذفه — وهذا هو الدليل على أن الشاشة كانت
   قد هاجرت فعلاً: حقلٌ لا يقرؤه أحد يُحذف بلا أثر. */
