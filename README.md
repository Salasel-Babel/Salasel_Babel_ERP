...
| الوجهة | ماذا فيها |
|---|---|
| [`deploy/README.md`](deploy/README.md) | **جدول الأسرار والمتغيّرات** الذي يجعل النشر ممكناً، وقرار TLS الذي يملكه المالك وحده، وما جُرّب وما لم يُجرَّب |
| [`demo/company/README.md`](demo/company/README.md) | الشركة التجريبية: ثمانية أشهر من النشاط **كلّها عبر محرّك الترحيل**، وميزانها وسلسلتها وأعمار ذممها |

```bash
deploy/up.sh          # أمر واحد يُقيم الحزمة محلياً ويطبع الرابط والرمز
```
