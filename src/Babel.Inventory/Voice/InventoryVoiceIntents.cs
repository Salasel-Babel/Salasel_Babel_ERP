...
public sealed class InventoryVoiceIntents : IVoiceIntentCatalogue
{
    ...
    [
        new VoiceIntent(
            ...
            [
                new VoiceSlot("item", VoiceSlotKind.Code, "الصنف", true,
                    ["الصنف", "صنف", "للصنف", "من"], []),
                new VoiceSlot("quantity", VoiceSlotKind.Quantity, "الكمية الفعلية", true,
                    ["كمية", "الكمية", "عدد", "العدد", "بمقدار", "لقيت"], []),
                new VoiceSlot("warehouse", VoiceSlotKind.Code, "المستودع", true,
        ...
        new VoiceIntent(
            ...
            [
                ...
                new VoiceSlot("warehouse", VoiceSlotKind.Code, "المستودع", true,
                    ["المستودع", "مستودع", "المخزن", "مخزن"], []),
                new VoiceSlot("project", VoiceSlotKind.Entity, "المشروع", true,
                    ["للمشروع", "المشروع", "مشروع"], [], "project"),
        ...
        new VoiceIntent(
            ...
            [
                new VoiceSlot("item", VoiceSlotKind.Code, "الصنف", true,
                    ["الصنف", "صنف", "من"], []),
                new VoiceSlot("warehouse", VoiceSlotKind.Code, "المستودع", false,
                    ["المستودع", "مستودع", "المخزن", "مخزن"], []),
            ],
            false,
            null),
        ...
        new VoiceIntent(
            ...
            [
                ...
                new VoiceSlot("quantity", VoiceSlotKind.Quantity, "الكمية المحوَّلة", true,
                    ["كمية", "الكمية", "عدد", "بمقدار"], []),
                new VoiceSlot("fromWarehouse", VoiceSlotKind.Code, "المستودع المرسِل", true,
                    ["من مستودع", "من المستودع", "من مخزن"], []),
                new VoiceSlot("toWarehouse", VoiceSlotKind.Code, "المستودع المستقبِل", true,
