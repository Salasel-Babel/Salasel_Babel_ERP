...
describe("النسخ عن المصدر ليس ترجمة — والثقب الباقي مُعلَن ومُقاس", () => {
  ...
  it("‏**الثقب**: شرط الثلاث كلمات ليس ذوقاً — تضييقه إلى واحدة يُنتج ستّ حمراوات كاذبة", () => {
    ...
    /* عشرُ قيمٍ أردية تطابق العربية حرفاً بحرف، وكلُّها مصطلحٌ واحد أو اسمُ
       ...
       وحدات القياس «وزن» و«حجم» و«طول»، وأضافت شاشةُ دليل الحسابات
       «مقابل» — وهي كلماتٌ أردية صحيحة تقع بحروفها العربية نفسها،
       وتغييرُها إلى غيرها يُفسد الترجمة كي يُرضي عدّاداً. والشرط الحاكم
       تحته — أن يكون المصطلح أقلّ من ثلاث كلمات — هو ما يبقى حاكماً. */
    expect(identical.length).toBe(10);
