...
| الإدارة العقارية (الإيجارات والملاك) | قيد التحليل — موصّف في `07-real-estate.md` |
...
| [07-real-estate.md](docs/analysis/07-real-estate.md) | الإدارة العقارية: نموذجا العمل ومصفوفة الترحيل والقرارات المفتوحة |
