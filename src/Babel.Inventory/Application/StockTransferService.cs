...
/// قيد مالي إطلاقاً». والنقل بين موقعين لا يبلغ ذلك الشرط أبداً: المؤهّل مجموعةُ
/// الصنف، وهي لا تتغيّر بنقل مكان. ولذلك أُضيف
/// <c>inventory.transfer.between_locations</c> إلى المصفوفة بـ<c>posts_entry: false</c>
/// وبلا سطور — <b>مكتوباً هناك</b> كي لا يبقى «لا قيد» قراراً في شيفرة.
/// </para>
/// <para>
