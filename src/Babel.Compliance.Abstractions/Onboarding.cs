...
public interface IOnboardingChannel
{
    ...
    /// </summary>
    ValueTask<CsrMaterial> CreateSigningRequestAsync(CsrRequest request, CancellationToken ct);
    ...
    ValueTask<ComplianceCheckResult> RunComplianceChecksAsync(
        CredentialRef credential, CancellationToken ct);
    ...
    ValueTask RevokeAsync(CredentialRef credential, string reason, CancellationToken ct);
}
