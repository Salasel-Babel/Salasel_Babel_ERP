...
/// وأثرُ الخلط لم يكن نظرياً: كلُّ حدث ترحيلٍ جديد يضيف نحو سبعة مواضع شرحٍ فيكسر سقفاً
/// <b>لا يرتفع</b> — فسُحب حدث <c>inventory.transfer.between_locations</c> عند «866
/// والسقف 862»، وصار النموّ ممنوعاً بنيوياً في كل الوحدات.
/// </para>
/// <para>
...
public sealed class Rule14_TranslationsAreRowsNotColumns
{
    ...
    /// <para>
    /// ستّ صيغ، وكلٌّ منها <b>يضع الاسم الإنجليزي الثابت في جدول</b> — وهو وحده ما يعجز
