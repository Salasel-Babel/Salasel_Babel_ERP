...
public sealed class SalesOptions
{
    ...
    public const string ConnectionVariable = "BABEL_SALES_DB";

    /// <summary>مفتاح الإعداد المكافئ في الجذر التركيبي.</summary>
    public const string ConfigurationKey = "Babel:Sales:ConnectionString";

    /// <summary>اسم قاعدة التطوير المحلّي — لا يُبلَغ إلا في وضع التطوير المُعلَن.</summary>
    public const string DefaultDatabase = "babel_sales";
