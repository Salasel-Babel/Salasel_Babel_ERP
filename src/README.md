...
### القاعدة 10 · الشكل القانوني مختوم
`Rule10_TheCanonicalFormIsSealed.cs`
...
### القاعدة 11 · محرك الترحيل يحمل الثوابت المقيسة
`Rule11_ThePostingPathIsTheOnlyWriteToTheLedger.cs`

القواعد العشر الأولى تحرس **الحدود**؛ هذه تحرس **السلوك المقيس** داخل الدفتر. كل بند فيها
