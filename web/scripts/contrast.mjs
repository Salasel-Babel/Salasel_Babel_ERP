...
export const COMPONENT_FILES = [
  ...
  "presence.css",
  "motion.css",
  /* ‏`touch.css` **لا لون فيه** — قياسُ لمسٍ ورجعُ ضغطٍ وحدهما. ومذكورٌ هنا
     مع ذلك لأن حارس التغطية أدناه مشتقٌّ من هذه القائمة: ملفٌّ خارجها يستطيع
     أن يُدخل زوجاً غير مقيس ولا يعلم به أحد. فوجودُه هنا هو ما يجعل خلوَّه
     من اللون **مفروضاً لا مُدَّعى**. */
  "touch.css",
];
