...
public sealed class CaptureCarriesAReferenceNotTheBytes
{
    ...
    [
        ...
        // وما هنا ليس مستنداً ولا جزءاً منه: حمولةٌ ثنائية ثابتة الطول (نسخة · غرض ·
        // منشأة · شركة · جلسة · موضوع · انتهاء) وعليها HMAC-SHA256، تُرمَّز base64url
        // لتعبر مسار URL بلا ترميزٍ ثانٍ. لا بايتة من صورةٍ ولا من ملفّ تمرّ من هنا،
        // ولا يوجد في هذا الملفّ ما يقبل `byte[]` من مستدعٍ أصلاً.
        //
