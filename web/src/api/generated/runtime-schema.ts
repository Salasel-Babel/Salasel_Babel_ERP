...
export const SCHEMAS: Readonly<Record<string, SchemaShape>> = {
  ...
  CapabilitySwitch: { required: ["capability","enabled"], fields: {"capability":{"e":["advance","cost_of_sales","retention"],"k":"plain"},"enabled":{"k":"plain"}} },
  ...
  DocumentAdmission: { required: ["admitted","documentType","fields"], fields: {"admitted":{"k":"plain"},"documentType":{"e":["projects.client_certificate","sales.invoice"],"k":"plain"},"fields":{"i":{"k":"plain"},"k":"array"}} },
  DocumentProfile: { required: ["capabilities","documentType"], fields: {"capabilities":{"i":{"k":"ref","r":"CapabilitySwitch"},"k":"array"},"defaults":{"i":{"k":"ref","r":"NameValue"},"k":"array"},"documentType":{"e":["projects.client_certificate","sales.invoice"],"k":"plain"}} },
  DocumentShape: { required: ["availableCapabilities","defaults","documentType","enabledCapabilities","fields","module","nameAr","nameKey"], fields: {"availableCapabilities":{"i":{"e":["advance","cost_of_sales","retention"],"k":"plain"},"k":"array"},"defaults":{"i":{"k":"ref","r":"NameValue"},"k":"array"},"documentType":{"e":["projects.client_certificate","sales.invoice"],"k":"plain"},"enabledCapabilities":{"i":{"e":["advance","cost_of_sales","retention"],"k":"plain"},"k":"array"},"fields":{"i":{"k":"plain"},"k":"array"},"module":{"e":["Core","Ledger","Sales","Purchasing","Compliance","Inventory","Pos","Hr","Projects","RealEstate","Assets","Portals","Ai"],"k":"plain"},"nameAr":{"k":"plain"},"nameKey":{"k":"plain"}} },
