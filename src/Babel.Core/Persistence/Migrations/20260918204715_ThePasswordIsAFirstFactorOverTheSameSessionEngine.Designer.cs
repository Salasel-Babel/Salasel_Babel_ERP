...
namespace Babel.Core.Persistence.Migrations
{
    ...
    [Migration("20260918204715_ThePasswordIsAFirstFactorOverTheSameSessionEngine")]
    internal partial class ThePasswordIsAFirstFactorOverTheSameSessionEngine
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Babel.Core.Persistence.AccessSignInRow", b =>
                {
                    ...
                    b.HasKey("Handle")
                        .HasName("pk_access_sign_in");

                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasDatabaseName("ux_access_sign_in_user");

                    b.ToTable("access_sign_in", "core", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_access_sign_in_proof_shape", "proof ~ '^[a-z0-9-]+\\$[0-9]+\\$[A-Za-z0-9+/=]+\\$[A-Za-z0-9+/=]+$'");
                        });
                });
