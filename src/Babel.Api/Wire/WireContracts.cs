...
internal sealed record PostJournalEntryRequestDto
{
    ...
    /// <summary>سطور الطلب — للمسار الصريح. تكون فارغة حين يُضبط <see cref="Event"/>.</summary>
    public IReadOnlyList<PostingLineDto> Lines { get; init; } = [];

    /// <summary>رمز الحدث في مصفوفة الترحيل، إن كان الطلب على مسار القالب.</summary>
...
/// عائمة أصلاً؛ وسطح الدفتر لا يكشفه اليوم، وهو تغيير مطلوب مسجَّل في ADR-0016.
/// </para>
/// <para>
