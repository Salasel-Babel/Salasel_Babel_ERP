...
/* **والافتراض صار الفاتح، ونسخَ ما قرّرته ADR-0055 بنصّ المالك نفسه.**
   السببُ أن المنتج تغيّر لا الذوق: داكنٌ سينمائيّ يليق بعرضٍ يُبهر، ونظامٌ
   محاسبيّ يُباع يُفتح أوّلَ مرّة على ما يتوقّعه المحاسب — ورقٌ أبيض وحبرٌ
   داكن. والداكنُ يبقى **بديلاً كاملاً لا مهجوراً**: مبدّلُ المظهر في مكانه،
   والسمتان مكتوبتان بالرموز نفسها في `theme-default.css`، ولوحةُ الوصولية
   تعمل فوق كلتيهما. والتذييلُ في ADR-0055 يحمل هذا النسخ ومبرّره. */
