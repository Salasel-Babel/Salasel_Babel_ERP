...
/// <para/>
/// <c>internal</c> وفي فضاء <c>Babel.Compliance.Persistence</c>: كل وحدة تملك جداولها،
/// ولا يحقن أحد سياق وحدة أخرى — مفروض ببناء في Rule05.
/// </summary>
internal sealed class ComplianceDbContext(DbContextOptions<ComplianceDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SubmissionAttempt>(e =>
        {
        ...
        modelBuilder.Entity<IssuingUnitChainHead>(e =>
        {
        ...
        modelBuilder.Entity<ComplianceWorkItem>(e =>
        {
        ...
        modelBuilder.Entity<ReconciliationFinding>(e =>
        {
