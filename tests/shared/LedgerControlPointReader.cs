...
/// <para>
/// <b>موضعه الطبيعي هو الجذر التركيبي</b> (‏<c>Babel.Api</c>): الوحدة تستهلك المنفذ
/// ولا تعرف الدفتر، والدفتر لا يعرف الوحدة، والجذر وحده يعرف الاثنين. وُضع هنا لأن
/// الجذر ليس ملك هذا التسليم — وهو بند في التقرير.
/// </para>
/// <para>
/// <b>وملفٌّ واحد تربطه ثلاثة مشاريع اختبار بـ<c>Compile Include</c>.</b> كان مكتوباً
/// <b>ثلاث مرّات</b> متطابقةً بايتاً بايت (عدا سطرَي تعليق)، وهو الشكل الذي وصفته
/// <c>docs/evidence/traps.md#fakh-81</c>: قاعدةٌ واحدة في مواضع بلا حارس يربطها.
/// </para>
/// <para>
