...
public sealed class PurchasingVoiceIntents : IVoiceIntentCatalogue
{
    ...
    [
        new VoiceIntent(
            ...
            "Capture a supplier expense bill",
            [
                "سجل فاتورة مصروف", "قيد فاتورة مصروف", "فاتورة مصروف", "ادخل فاتورة مورد",
                "اكتب فاتورة مورد", "عندي فاتورة مصروف",
            ],
            [
                new VoiceSlot("supplier", VoiceSlotKind.Text, "المورد", "Supplier", true,
                    ["من", "المورد", "مورد", "باسم", "لصالح"], []),
                new VoiceSlot("amount", VoiceSlotKind.Money, "الإجمالي شامل الضريبة", "Gross total", true,
                    ["بمبلغ", "مبلغ", "بقيمة", "قيمتها", "قيمته", "الاجمالي", "اجمالي", "المجموع"], []),
                new VoiceSlot("taxRate", VoiceSlotKind.Number, "نسبة الضريبة", "Tax rate", false,
                    ["ضريبة", "وضريبة", "الضريبة", "بنسبة"], []),
                new VoiceSlot("billNumber", VoiceSlotKind.Code, "رقم الفاتورة", "Bill number", false,
                    ["رقم", "برقم", "رقمها"], []),
                new VoiceSlot("issuedOn", VoiceSlotKind.Date, "تاريخ الإصدار", "Issued on", true, [], []),
            ],
            false,
            null,
            null),
        ...
        new VoiceIntent(
            ...
            [
                ...
                new VoiceSlot("amount", VoiceSlotKind.Money, "المبلغ المدفوع", "Amount paid", true,
                    ["بمبلغ", "مبلغ", "بقيمة", "قيمته", "قيمتها"], []),
                new VoiceSlot("method", VoiceSlotKind.Choice, "طريقة الدفع", "Payment method", true,
                    [], ["نقد", "تحويل", "شيك", "شبكة"]),
