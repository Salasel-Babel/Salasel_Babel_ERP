...
for (const pass of PASSES) {
  ...
  test(`استقامةُ الصفوف · ${tag} (${pass.dir})`, async ({ page }) => {
    ...
    /* ‏**وحارسُ لافراغٍ للذيل نفسه**، وهو الذي كان ناقصاً: عند 390px لا صفَّ
       متعدّد الحقول، فكل حكمٍ مشروطٍ بالصفوف يمرّ على لا شيء. والذيل يُقاس
       لكل صفّ **بما فيه صفُّ الحقل الواحد**، فله عددٌ موجب في كل ممرّ. */
