...
public sealed class PurchasingVoiceIntents : IVoiceIntentCatalogue
{
    ...
    [
        ...
        new VoiceIntent(
            ...
            [
                new VoiceSlot("supplier", VoiceSlotKind.Entity, "المورد", true,
                    ["من المورد", "المورد", "مورد"], [], "supplier"),
                new VoiceSlot("item", VoiceSlotKind.Code, "الصنف", true,
                    ["الصنف", "صنف", "للصنف"], []),
        ...
        new VoiceIntent(
            ...
            [
                new VoiceSlot("supplier", VoiceSlotKind.Entity, "المورد", true,
                    ["من", "المورد", "مورد", "باسم", "لصالح"], [], "supplier"),
                new VoiceSlot("amount", VoiceSlotKind.Money, "الإجمالي شامل الضريبة", true,
        ...
        new VoiceIntent(
            ...
            [
                new VoiceSlot("supplier", VoiceSlotKind.Entity, "المورد", true,
                    ["للمورد", "المورد", "مورد", "لصالح", "الى"], [], "supplier"),
